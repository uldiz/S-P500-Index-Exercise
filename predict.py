...
sp["Volume"] = (sp["Volume"] - np.mean(sp["Volume"])) / np.std(sp["Volume"]) 
...
sp["Avg_Volume_5day"] = sp["Volume"].rolling(window=5).mean().shift(1)
sp["Avg_Volume_1yr"] = sp["Volume"].rolling(window=365).mean().shift(1)
sp["ratio_vol_5day_1yr"] = sp["Avg_Volume_5day"]/sp["Avg_Volume_1yr"]
sp["std_Volume_5day"] = sp["Volume"].rolling(window=5).std().shift(1)
sp["std_Volume_365day"] = sp["Volume"].rolling(window=365).std().shift(1)
sp["ratio_vol_std_5day_1yr"] = sp["std_Volume_5day"] / sp["std_Volume_365day"]
...
features = ["Av_5day", "Av_30day", "Av_1yr", "ratio_mean_5day_1yr", "sd_5day", "sd_30day", "sd_365day", "ratio_std_5day_1yr", "ratio_std_5day_30day", "Avg_Volume_5day", "Avg_Volume_1yr", "ratio_vol_5day_1yr"]
y_train = train["Close"]
y_test = test["Close"]
...
sns.kdeplot(predictions, y_test)
plt.show()
